...
class BoxCollection {
  ...
  Future<CollectionBoxIndexedDb<V>> openBox<V>(String name,
      {bool preload = false,
        CollectionBoxIndexedDb<V> Function(String, BoxCollection)? boxCreator}) async {
    ...
    final box = boxCreator?.call(name, this) ?? CollectionBoxIndexedDb<V>(name, this);
    if (preload) {
